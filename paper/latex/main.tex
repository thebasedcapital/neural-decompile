...
\usepackage{graphicx}
\usepackage{hyperref}
% \usepackage{cleveref}  % install texlive-full for this
\usepackage{xcolor}
\usepackage{enumitem}
...
Code, data, and Kani proofs are publicly available.\footnote{Repository URL withheld for review.}
